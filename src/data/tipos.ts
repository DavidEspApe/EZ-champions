...
// TYPE_CHART[Ataque][Defensor] = Multiplicador
...
// Función maestra para calcular debilidades
export const getEffectiveness = (attackType: PokemonType, defenderTypes: PokemonType[]): number => {
  let multiplier = 1;
